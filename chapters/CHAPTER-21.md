...
> - **Setting**: **Puerto Peñasco → Mexicali** (~March–August 2025). The next hustle after the call-center money died (Ch20). Opens on the web-design scrape-by in Peñasco, pivots on **Rose's near-fatal car wreck**, moves the family into Rose's Mexicali house to nurse her (~4 months), and builds toward the **Brewmetrics** SaaS rise-and-collapse — the AI obsession (planted Ch10) finally built, finally finished, and the wheels coming off the exact same way they always do.
> - **Timeline**: Direct continuation of Ch20. After the Brandy bailout, Clay starts **selling websites to small businesses** out of Peñasco — a couple hundred bucks a pop, ~one a week, "scrape by by the skin of your teeth" money. **~April 2025: Rose drives up from Mexicali to visit** (the 3-hr Peñasco↔Mexicali run), stays half a day, starts back before dark, is **sun-blinded on a curve, runs off the road into a tree — punctured lung, both legs and an arm broken**, touch-and-go. The family **relocates to Mexicali into Rose's home to care for her (~4 months)**. During that stretch Clay builds **Brewmetrics** in the **vibe-coding era (2025)** — the culmination of his years of LLM copy-paste coding (the Ch10 garage/AI churn). **43 breweries signed at $49/mo pre-launch.** **Day 3 post-launch: an AZ taproom launch party spikes traffic → total collapse (all 43 down) →** six hours of forensics expose duct-tape auth, barely-there sessions, hardcoded storage, wide-open security. **Not a crash — a liability.** A week of humbling apology emails. **(⚠️ Timeline reconciliation: source draft said "2021 / GPT-3 Playground" — relocated to 2025 to fit the post-Sinaloa chronology; the old Playground/Copilot/Tabnine grind is reframed as Clay's apprenticeship, the finished build done on current vibe-coding tools.)**
> - **Characters**:
>   - **Clay**: Still the dial-delusion drunk (light from the Yetis, hidden from America), still paperless with two warrants. For the first time the move isn't *his* escape — they move for Rose. Builds the one thing in his life that worked and finished, and watches it collapse under real load. The chapter's mirror: he built the app the way he built himself — accept what looks right, ship it, never understand what's underneath, panic when real weight lands.
>   - **Glenda**: Nursing her broken mother; the steady hands. Drinking low alongside Clay (rule lifted since Ch17). Withheld-tears beat STILL unpaid — keep carrying it.
>   - **America** (~11–12): Thriving thread continues; shielded from the drink. Uprooted from the Peñasco school by the Mexicali move.
>   - **Rose** (Glenda's mother): The ex-con who asked Clay to keep her daughter sober (Ch16) — now broken in her own bed, nursed by the family in the house where Clay quietly keeps failing that one promise.
>   - **Brandy / Niki**: The lifelines behind him (Ch20); the scramble continues.
> - **Key Themes**: the next hustle; the move that isn't his escape (caretaking, not running); the AI obsession finally built; "I thought I'd made it" — the repeating beat (cf. Zaul's machine, Ch20); the beautiful rendering you can't live in yet (the app, the sobriety, the man); until-the-wheels-fell-off, again.
> - **Format**: forward-narrative, `---` dividers (no section headers), matching Ch17/Ch20.

---

So I started selling websites.

It's what I had. A man with a phone, a laptop, no passport, two warrants, and a gift for talking a stranger into something — that man can always find a thing to sell, and websites were the thing that spring. I'd cold-walk the small businesses of Puerto Peñasco, the taco stands and the dive shops and the little tienda that sold sunblock and cervezas to the Arizona tourists, and I'd tell them what I told everybody about everything: that they were leaving money on the table, that I could fix it, that it wouldn't cost them much. A couple hundred bucks a build. Maybe one a week if the week was kind. It wasn't good money. It wasn't even good-enough money. It was *scrape by by the skin of your teeth* money, the kind you spend before it clears, but we were doing it — rent covered, food on the table, a beer or two poured into the Yetis at night where the girl couldn't see — and after the call center died and the residual went into the ground with Zaul, *doing it* felt like a kind of winning.
...
The breweries lost their minds over it. I signed up forty-three of them at forty-nine bucks a month in the first week, and I hadn't even launched yet. I made the marketing videos with AI, and I'll tell you they were *good* — slick, hungry, the kind of thing that makes a brewmaster feel seen. Forty-three accounts. Recurring. Pre-launch.
...
We were still in Mexicali when the dust of it settled. Rose was mending. The websites were dead, the app was dead, the residual was long dead. And I did the only thing the man I still was knew how to do with a fresh pile of ruin — I started looking for the next thing to ship, grinning, certain, the dial right there in my hand where it had always been, dead wrong about absolutely everything, and pointed, though I couldn't have told you it yet, straight at a line on the map called Rosarito.
